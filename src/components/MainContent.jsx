    ...
    TuTor AI
                ...
                <div>
                  <div  className="h-10 w-10 border rounded-3xl flex">
                    {darkMode ?   <div onClick={toggle} className="m-1 cursor-pointer dark:invert">   <svg  xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-7">
